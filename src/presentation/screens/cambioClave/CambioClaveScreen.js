...
const CambioClaveScreen = ({ navigation }) => {
  return (
    <AppScreenLayout navigation={navigation}>
      <StatusBar barStyle="light-content" backgroundColor="#002c5d" />
      <ScreenHeader title="Cambio de Clave" onBack={() => navigation.goBack()} />
      <ScrollView style={styles.scrollView} contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        <View style={styles.placeholderContainer}>
          <View style={styles.iconCircle}>
            <Icon name="key-variant" size={48} color="#002c5d" />
          </View>
          <Text style={styles.placeholderTitle}>Cambio de Clave</Text>
          <Text style={styles.placeholderText}>
            Actualiza tu contraseña de acceso a la plataforma de manera segura.
          </Text>
        </View>
      </ScrollView>
    </AppScreenLayout>
...
export default CambioClaveScreen;
