      ...
      <ScrollView style={styles.scrollView} contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        <View style={styles.placeholderContainer}>
          <View style={styles.iconCircle}>
            <Icon name="clipboard-list" size={48} color="#002c5d" />
          </View>
          <Text style={styles.placeholderTitle}>Planeación</Text>
          <Text style={styles.placeholderText}>
            Consulta la planeación académica, cronogramas y actividades programadas.
          </Text>
        </View>
      </ScrollView>
    </AppScreenLayout>
...
export default PlaneacionScreen;
