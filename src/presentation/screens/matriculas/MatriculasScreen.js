...
const ROUTE_MAP = {
  'actualizacion-datos': 'ActualizacionDatos',
  'firma-electronica': 'FirmaElectronica',
  'informacion-servicios': 'InformacionServicios',
};

const MODULES = [
  { id: 'actualizacion-datos', icon: 'account-edit', title: 'Actualización de Datos', subtitle: 'Información personal y de contacto' },
  { id: 'firma-electronica', icon: 'draw', title: 'Firma Electrónica', subtitle: 'Firma digital de documentos' },
  { id: 'informacion-servicios', icon: 'information-variant', title: 'Información de Servicios', subtitle: 'Condiciones y servicios disponibles' },
];

const MatriculasScreen = ({ navigation }) => {
    ...
    <SafeAreaView style={styles.mainContainer} edges={['top']}>
      ...
      >
        ...
        <View style={styles.contextCard}>
          <Text style={styles.contextSubtitle}>Proceso de Matrícula</Text>
          <Text style={styles.contextTitle}>Gestión y documentación</Text>
        </View>
