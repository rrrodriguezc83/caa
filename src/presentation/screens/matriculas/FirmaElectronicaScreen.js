      ...
      <ScrollView style={styles.scrollView} contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        <View style={styles.placeholderContainer}>
          <View style={styles.iconCircle}>
            <Icon name="draw" size={48} color="#002c5d" />
          </View>
          <Text style={styles.placeholderTitle}>Firma Electrónica</Text>
          <Text style={styles.placeholderText}>
            Firma digitalmente los documentos requeridos para el proceso de matrícula.
          </Text>
        </View>
      </ScrollView>
...
export default FirmaElectronicaScreen;
