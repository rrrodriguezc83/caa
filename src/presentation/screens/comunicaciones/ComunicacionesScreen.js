...
const ComunicacionesScreen = ({ navigation }) => {
  return (
    <SafeAreaView style={styles.mainContainer} edges={['top']}>
      <StatusBar barStyle="light-content" backgroundColor="#002c5d" />
      <ScreenHeader title="Comunicaciones" onBack={() => navigation.goBack()} />
      <ScrollView style={styles.scrollView} contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        <View style={styles.placeholderContainer}>
          <View style={styles.iconCircle}>
            <Icon name="forum" size={48} color="#002c5d" />
          </View>
          <Text style={styles.placeholderTitle}>Comunicaciones</Text>
          <Text style={styles.placeholderText}>
            Revisa los comunicados institucionales, mensajes y avisos importantes.
          </Text>
        </View>
      </ScrollView>
    </SafeAreaView>
