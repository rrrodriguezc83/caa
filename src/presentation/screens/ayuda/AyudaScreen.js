      ...
      <ScrollView style={styles.scrollView} contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        <View style={styles.placeholderContainer}>
          <View style={styles.iconCircle}>
            <Icon name="help-circle" size={48} color="#002c5d" />
          </View>
          <Text style={styles.placeholderTitle}>Ayuda</Text>
          <Text style={styles.placeholderText}>
            Encuentra respuestas a preguntas frecuentes, soporte técnico y guías de uso de la plataforma.
          </Text>
        </View>
      </ScrollView>
    </SafeAreaView>
