...
const CalendarioCurricularScreen = ({ navigation }) => {
  return (
    <AppScreenLayout>
      <StatusBar barStyle="light-content" backgroundColor="#002c5d" />
      <ScreenHeader title="Calendario Curricular" onBack={() => navigation.goBack()} />
      <ScrollView style={styles.scrollView} contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        <View style={styles.placeholderContainer}>
          <View style={styles.iconCircle}>
            <Icon name="calendar-month" size={48} color="#002c5d" />
          </View>
          <Text style={styles.placeholderTitle}>Calendario Curricular</Text>
          <Text style={styles.placeholderText}>
            Consulta el calendario académico, fechas importantes, vacaciones y eventos institucionales.
          </Text>
        </View>
      </ScrollView>
    </AppScreenLayout>
...
export default CalendarioCurricularScreen;
